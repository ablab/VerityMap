...
using namespace tandem_mapper::cigar_utils;

inline char tandem_mapper::cigar_utils::cigar_mode2str(const CigarMode& fragment) {
...
std::ostream& tandem_mapper::cigar_utils::operator<<(std::ostream& os, const Cigar& cigar) {
