...
public:
    ...
    // Allowable min/max size of the bloom ban_filter in bits
    ...
    // into the bloom ban_filter, should be within one order
    // of magnitude. The default is 10000.
    unsigned long long int projected_element_count;

    // The approximate false positive probability expected
    // from the bloom ban_filter. The default is assumed to be
    ...
    virtual bool compute_optimal_parameters()
    {
        /*
          ...
          ban_filter consistent with the user defined false positive probability
        ...
        */
        ...
        // std::cout << optp.number_of_hashes << " " << optp.table_size << "\n";
        ...
        if (salt_count_ <= predef_salt_count)
        {
            ...
            for (std::size_t i = 0; i < salt_.size(); ++i)
            {
                /*
                   ...
                   so as to allow for the generation of unique bloom ban_filter
                   instances.
                */
